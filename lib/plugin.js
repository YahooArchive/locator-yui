...
PluginClass.prototype = {
    ...
    **/
    getLoaderData: function (bundleName, filter) {
        ...
        for (mod in meta) {
            if (meta.hasOwnProperty(mod)) {
                for (build in meta[mod].builds) {
                    if (meta[mod].builds.hasOwnProperty(build) && meta[mod].builds[build].config) {
        ...
        return Object.keys(obj.json).length && obj.data;
    },
    ...
    bundleUpdated: function (evt, api) {
        ...
        files = utils.filterFilesInBundle(bundle, evt.files, self.describe.filter);
        ...
        function generateServerData(fulfilled) {
        ...
        function generateClientData(fulfilled) {
        ...
        function shiftEverything(fulfilled, rejected) {
        ...
        return api.promise(generateServerData)
            ...
            .then(function (loaderData) {
                ...
                // writting meta module if needed
        ...
        for (i = 0; i < jsonFiles.length; i += 1) {
            if (libpath.basename(jsonFiles[i]) === 'build.json') {
                ...
                if (mod) {
                    ...
                    this.register(bundle, jsonFiles[i], mod);
                }
            }
        }
