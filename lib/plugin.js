...
configuration of the plugin.
    ...
    @param {object} config.lint Optional enable linting in shifter.
    @param {object} config.coverage Optional generate `-coverage.js` version of modules in shifter.
    @param {object} config.silent Optional run shifter in silent mode.
    @param {object} config.quiet Optional run shifter in quiet mode.
...
PluginClass.prototype = {
    ...
    **/
    ...
    bundleUpdated: function (evt, api) {
        ...
        generateClientData = self.generateClientDataFactory(bundle);
        ...
        attachClientData = self.attachClientDataFactory(bundle);
        ...
        return api.promise(generateServerData)
            ...
            .then(attachClientData(bundle, api, destination_path))
            .then(function (newfile) {
                if (newfile) {
                    // store a fullpath to the file into the bundle for others components to use it
